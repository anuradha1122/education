...
$x =  0;
$y = 1;
if(isset($_SESSION['ad_id']) AND isset($_GET['number'])){
  ...
  if($admin['position'] == 6){
    ...
    if($office['eo_id']==$school['edu_division']){
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   if(isset($_POST['submit'])){
      ...
      if(isset($_POST['com_lab_si']) AND $_POST['com_lab_si'] <> ''){
        $com_lab_si    = $database -> post_to_variabal($_POST['com_lab_si']);
        $update       = $database -> update_one_column('school_subject', 'com_lab_si', $com_lab_si, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['com_lab_tm']) AND $_POST['com_lab_tm'] <> ''){
        $com_lab_tm    = $database -> post_to_variabal($_POST['com_lab_tm']);
        $update       = $database -> update_one_column('school_subject', 'com_lab_tm', $com_lab_tm, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['com_lab_en']) AND $_POST['com_lab_en'] <> ''){
        $com_lab_en    = $database -> post_to_variabal($_POST['com_lab_en']);
        $update       = $database -> update_one_column('school_subject', 'com_lab_en', $com_lab_en, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['sp_need']) AND $_POST['sp_need'] <> ''){
        $sp_need    = $database -> post_to_variabal($_POST['sp_need']);
        $update       = $database -> update_one_column('school_subject', 'sp_need', $sp_need, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['students']) AND $_POST['students'] <> ''){
        $students    = $database -> post_to_variabal($_POST['students']);
        $update       = $database -> update_one_column('school_subject', 'students', $students, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['lib']) AND $_POST['lib'] <> ''){
        $lib    = $database -> post_to_variabal($_POST['lib']);
        $update       = $database -> update_one_column('school_subject', 'lib', $lib, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['min_reli']) AND $_POST['min_reli'] <> ''){
        $min_reli    = $database -> post_to_variabal($_POST['min_reli']);
        $update       = $database -> update_one_column('school_subject', 'min_reli', $min_reli, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['pristu']) AND $_POST['pristu'] <> ''){
        $pristu    = $database -> post_to_variabal($_POST['pristu']);
        $update       = $database -> update_one_column('school_subject', 'pristu', $pristu, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['olstu']) AND $_POST['olstu'] <> ''){
        $olstu    = $database -> post_to_variabal($_POST['olstu']);
        $update       = $database -> update_one_column('school_subject', 'olstu', $olstu, 'sc_id', $school['sc_id']);
      }

      if(isset($_POST['alstu']) AND $_POST['alstu'] <> ''){
        $alstu    = $database -> post_to_variabal($_POST['alstu']);
        $update       = $database -> update_one_column('school_subject', 'alstu', $alstu, 'sc_id', $school['sc_id']);
      }
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Computer Lab Amount Sinhala"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="com_lab_si" value="<?php echo $school_subject['com_lab_si']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Computer Lab Amount Tamil"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="com_lab_tm" value="<?php echo $school_subject['com_lab_tm']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Computer Lab Amount English"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="com_lab_en" value="<?php echo $school_subject['com_lab_en']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Special needs Student Amount"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="sp_need" value="<?php echo $school_subject['sp_need']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Full Student Amount"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="students" value="<?php echo $school_subject['students']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Librarys"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="lib" value="<?php echo $school_subject['lib']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("Students who belong to religious minorities"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="min_reli" value="<?php echo $school_subject['min_reli']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("1-5 Student Amount"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="pristu" value="<?php echo $school_subject['pristu']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("6-11 Student Amount"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="olstu" value="<?php echo $school_subject['olstu']; ?>" style="width: 70%;">
    </div>
  </div>

  <div class="row">
    <div class="col-sm-3 col-sm-offset-3 col-xs-6 col-xs-offset-0 justify-content-center text-center">
      <?php $database -> display_message("12-13 Student Amount"); ?>
    </div>
    <div class="col-sm-3  col-xs-6 justify-content-center text-center">
      <input type="number" name="alstu" value="<?php echo $school_subject['alstu']; ?>" style="width: 70%;">
    </div>
  </div>
