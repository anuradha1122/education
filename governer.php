...
<div class="container-fluid">
  ...
  <div class="row" style="padding-top: 50px;">
    <div class="col-xs-3 col-xs-offset-3 text-center">
      <img class="animated flipInY slower" src="img/damma.gif" style="width: 80%;height: 80%">
    </div>
  ...
  <div class="row text-center">
    <h1 style="font-family: 'hgs4b',Arial, sans-serif;">Governer's Message</h1>
  </div>
  <div class="row text-center">
    <div class="col-xs-8 col-xs-offset-2">
    <h4>It is my pleasure to add my greetings to the website of Sambaragamuwa Education Management Information System (SEMIS) launched today by His Exultancy Maithripala Sirisena, the President of Democratic Socialist Republic of Sri Lanka.</h4>
  <h4>Computerization of the data of Sabaragamuwa provincial education service that consist of 1128 government schools, 400634 students and 1128 principles is a  great service to the people of the country.
  In this era, It is a responsibility of any public service to facilitate the citizens to get information of the services they receive from their government where the Right to information act no 12 of 2016 is also active.
  I thank all officials who worked to make this task successful including Mr. Mahinda S. Weerasooriya, Secretary to the Sabaragamuwa Provincial Ministry of Education, Information Technology and Cultural Affairs and Mr. Sepala Kuruppuarachchi, the Sabaragamuwa Provincial Director of Education.</h4>
  <h4>I wish that this Education Management Information System (SEMIS) be a great help to provide a systematic and efficient education service not only to the people of Sabaragamuwa Province, but to the all citizens of Sri Lanka.</h4>
  <h4>Dhamma Dissanayake</h4>
  <h4>The Governor of Sabaragamuwa Province</h4>
  </h2>
    </div>
  </div>
