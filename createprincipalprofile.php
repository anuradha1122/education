...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $success  = $database -> insert_principal_temp($emp_no,$first_name,$middle_name,$last_name,$sir_name,$birthday,$add_li1,$add_li2,$add_li3,$division,$gender,$race,$religion,$civil_status,$app_date,$nic,$tel,$medium,$position,$ed_qu,$pr_qu,$rank,$email,$password,$creator,$ip,$host_name,$school);
    ...
    if($success <> '') {
        if(isset($school2) AND isset($f_date2)){
            $database -> insert_principal_history($nic,$school2['school_no'],$f_date2);
        }
        ...
        if(isset($school3) AND isset($f_date3)){
            ...
            $database -> insert_principal_history($nic,$school3['school_no'],$f_date3);
        }
        ...
        if(isset($school4) AND isset($f_date4)){
            ...
            $database -> insert_principal_history($nic,$school4['school_no'],$f_date4);
        }
        ...
        if(isset($school5) AND isset($f_date5)){
            ...
            $database -> insert_principal_history($nic,$school5['school_no'],$f_date5);
        }
    }
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12 text-center">
      <h3>CREATE PRINCIPAL PROFILE</h3>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-4 col-sm-offset-4 col-xs-offset-0 justify-content-center">
      ...
      <table class = "table table-hover">
        ...
        <td id="tableBox"><select name="position"> <?php $position_query = $database ->table_search_by_element('principal','position','level');
