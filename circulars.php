...
<div class="container-fluid">
  ...
  <div class="row">
      <div class="col-sm-6 col-sm-offset-3 col-xs-12 col-xs-offset-0 text-center justify-content">
        ...
        <a href="http://www.moe.gov.lk/english/index.php?option=com_circular&view=circulars&Itemid=920">
        ...
        <a href="http://www.pubad.gov.lk/web/index.php?option=com_circular&Itemid=109&lang=en">
        <div class="col-sm-6 col-xs-12">
          <img src="img/guides.gif" style="width: 100%;height: 100%;">
          <div class="col-xs-12 tile" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);">
            <h3>Ministry of Public Administration </h3>
          </div>
        </div>
        </a>
      </div>
