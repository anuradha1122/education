...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $emp_no       = strtoupper($database -> form_data_process('emp_no'));
    ...
    $sub4         = $database -> post_to_variabal($_POST['for_sub']);
    $sub5         = $database -> post_to_variabal($_POST['fif_sub']);

    $email        = strtolower($database -> form_data_process('email'));
  ...
  <div class="row">
    <div class="col-sm-4 col-sm-offset-4 col-xs-offset-0 justify-content-center">
      ...
      <table class = "table table-hover">
        ...
        <tr>
        <td id ="tableField">Emplyee Number:</td>
        <td id="tableBox"><input type="text" name="emp_no" maxlength="16" value=""></td>
        </tr>
        ...
        <td id="tableBox"><select name="division" ><?php $div_query = $database -> find_division();
        ...
        <td id="tableBox"><input type="text" name="school" maxlength="8" value=""></td>
        </tr>
        ...
        <td id="tableBox"><select name="position"> <?php $position_query = $database ->table_search_by_element('teacher','position','level');
        ...
        <td id="tableBox"><select name="first_sub"> <?php $sub_query = $database ->table_search('subject');
          while($subject = mysqli_fetch_assoc($sub_query)){ ?> 
          <option value="<?php echo $subject['su_id']; ?>"><?php echo $subject['name']?></option> <?php }?></select></td>
        </tr>

        <tr>
        <td id ="tableField">Teaching Subject 1:</td>
        <td id="tableBox"><select name="sec_sub"><option value="0" selected>-None-</option> <?php $sub_query = $database ->table_search('subject');
          while($subject = mysqli_fetch_assoc($sub_query)){ ?> 
          <option value="<?php echo $subject['su_id']; ?>"><?php echo $subject['name']?></option> <?php } ?></select></td>
        </tr>
        ...
        <td id="tableBox"><select name="third_sub"><option value="0" selected>-None-</option><?php $sub_query = $database ->table_search('subject');
          while($subject = mysqli_fetch_assoc($sub_query)){?> 
          <option value="<?php echo $subject['su_id']; ?>"><?php echo $subject['name']?></option> <?php } ?></select></td>
        </tr>
        ...
        <td id="tableBox"><select name="for_sub"><option value="0" selected>-None-</option> <?php $sub_query = $database ->table_search('subject');
          while($subject = mysqli_fetch_assoc($sub_query)){ ?> 
          <option value="<?php echo $subject['su_id']; ?>"><?php echo $subject['name']?></option> <?php } ?></select></td>
        </tr>

        <tr>
        <td id ="tableField">Teaching Subject 4:</td>
        <td id="tableBox"><select name="fif_sub"><option value="0" selected>-None-</option><?php $sub_query = $database ->table_search('subject');
          while($subject = mysqli_fetch_assoc($sub_query)){?> 
          <option value="<?php echo $subject['su_id']; ?>"><?php echo $subject['name']?></option> <?php } ?></select></td>
        </tr>

        <tr>
        <td id ="tableField">E-mail:</td>
        <td id="tableBox"><input type="text" name="email" maxlength="50" value=""></td>
        </tr>
        ...
        <tr>
        <td id ="tableField">Pass Word:</td>
        <td id="tableBox"><input type="password" name="password" maxlength="10" minlength="6" value=""></td>
        </tr>
