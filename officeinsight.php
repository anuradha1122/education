...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <h4><?php $database -> display_message($office['name']); ?>
          <?php $database -> display_message(" ("); ?>
          <?php $database -> display_message($office['office_no']); ?>
          <?php $database -> display_message(")"); ?>
      </h4>
    </div>
  </div> 
      ...
      <div class="col-sm-4 col-sm-offset-4 col-xs-offset-0 justify-content-center">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td>
              <?php $database -> display_message($office['add_li1']); ?>
            </td>
          </tr>
          <?php if($office['add_li2']) { ?>
          <tr>
            <td id="tableField">
              <?php $database -> display_message(" "); ?>
            </td>
            <td>
              <?php $database -> display_message($office['add_li2']); ?>
            </td>
          </tr>
        <?php } ?>
          <tr>
            <td id="tableField">
              <?php $database -> display_message("Telephone : "); ?>
            </td>
            <td>
              <?php $database -> display_message($office['telephone']); ?>
            </td>
          </tr>
          <tr>
            <td id="tableField">
              <?php $database -> display_message("Email : "); ?>
            </td>
            <td>
              <?php $database -> display_message($office['email']); ?>
            </td>
          </tr>
          <tr>
            <td id="tableField">
              <?php $database -> display_message("Office No : "); ?>
            </td>
            <td>
              <?php $database -> display_message($office['office_no']); ?>
            </td>
